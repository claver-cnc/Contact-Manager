...
class ContactManager:
    ...
    def addContact(self):
        ...
        myNum = raw_input("Enter the phone number of your contact: ")
        myMail = raw_input("Enter the email of this person: ")
...
while boucle == 0:
    ...
    if choice == 1:
        ...
        while add == 0:
            ...
            answer = raw_input("Would you want to add a new contact ? Yes || No \n")
            if answer != "Yes":
                add = 1
